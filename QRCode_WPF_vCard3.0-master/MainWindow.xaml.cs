...
namespace BusinessCardQR
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private DataTable GetDataTableFromUploadedExcel(string path)
        {
            using (DataTable dt = ReadExcelFileDOM(path))
            {
                if (dt.Rows.Count >= 1 && dt.Columns.Count == 11)
                {
                    ...
                    dt.Columns[0].ColumnName = "Prenom";
                    dt.Columns[1].ColumnName = "Prenom1";
                    dt.Columns[2].ColumnName = "Nom";
                    dt.Columns[3].ColumnName = "Organization";
                    dt.Columns[4].ColumnName = "Fonction";
                    dt.Columns[5].ColumnName = "Mobile";
                    dt.Columns[6].ColumnName = "Mobile1";
        ...
        private void GenerateQRCode(object sender, RoutedEventArgs e)
        {
            ...
            {
                MessageBox.Show("Please upload Data excel sheet with valid data.");
            }
        }
        ...
        private DataView GetEmpyView()
        {
            ...
            DataColumn col1 = new DataColumn("Prenom", typeof(String));
            DataColumn col2 = new DataColumn("Prenom1", typeof(DateTime));
            ...
            DataColumn col7 = new DataColumn("Mobile1", typeof(String));
        ...
        private void btnUploadExcel_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        MessageBox.Show("Please upload data excel sheet.");
                    }
                }
            }
            catch (Exception ex)
